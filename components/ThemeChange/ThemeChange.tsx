...
const SunIcon = () => {
  ...
  return (
    <motion.svg key="sun" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" whileTap={whileTap}>
      <motion.circle
        cx="11.9998"
        cy="11.9998"
        r="5.75375"
      ...
      <motion.g initial="initial" animate="animate" variants={raysVariants}>
        <circle cx="3.08982" cy="6.85502" r="1.71143" transform="rotate(-60 3.08982 6.85502)" fill="#FFCE31" />
        <circle cx="3.0903" cy="17.1436" r="1.71143" transform="rotate(-120 3.0903 17.1436)" fill="#FFCE31" />
        <circle cx="12" cy="22.2881" r="1.71143" fill="#FFCE31" />
        <circle cx="20.9101" cy="17.1436" r="1.71143" transform="rotate(-60 20.9101 17.1436)" fill="#FFCE31" />
        <circle cx="20.9101" cy="6.8555" r="1.71143" transform="rotate(-120 20.9101 6.8555)" fill="#FFCE31" />
...
ThemeChange.displayName = "ThemeTile";
